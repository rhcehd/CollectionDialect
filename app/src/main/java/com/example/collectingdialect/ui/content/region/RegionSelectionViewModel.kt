...
class RegionSelectionViewModel: BaseViewModel() {
    companion object {
        ...
        const val REGION_GANGWON = "강원도"
        const val REGION_CHUNGNAM = "충청남도"
        const val REGION_CHUNGBUK = "충청북도"
        const val REGION_GYEONGNAM = "경상남도"
        const val REGION_GYEONGBUK = "경상북도"
        const val REGION_JEONNAM = "전라남도"
        const val REGION_JEONBUK = "전라북도"
        const val REGION_JEJU = "제주도"
    }
    ...
    var regionSelectResultCallback: ((String) -> Unit)? = null
    ...
    fun onClickNext(view: View) {
        ...
        if(region == REGION_NO_SELECT) {
            ...
            regionSelectResultCallback?.invoke(region)
        }
